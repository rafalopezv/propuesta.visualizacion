...
<br>
<img src="img/cronograma.png" height="500" width="500">
...
Cada uno de los bloques estará acompañado de una sesión práctica, en la que los participantes aprenderán a aplicar lo desarrollado. Para todas las sesiones prácticas se proporcionará:
 ...
 Todo el material podrá ser entregado con 10 días de anticipación al inicio del curso.

## Presupuesto

- El curso dura 15 horas, dividas en 6 bloques de 2.5 horas
- El presupuesto de cada bloque de 2.5 horas es de 835 Bolivianos
- El presupuesto total es de 5010 Bolivianos, incluyendo impuestos de ley
